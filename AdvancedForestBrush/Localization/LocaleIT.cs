    ...
    public sealed class LocaleIT : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetBindingKeyLocaleID(Setting.kAddSpeciesAction), "Aggiungi pianta all'elenco" },
                { m_Setting.GetBindingKeyHintLocaleID(Setting.kAddSpeciesAction), "Aggiungi la pianta selezionata all'elenco" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesMouse)), "Aggiungi pianta (mouse)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesMouse)), "Fai clic su una pianta nella barra tenendo premuta la combinazione assegnata. Predefinito: Ctrl + clic sinistro." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Aggiungi pianta (tastiera)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Tasto facoltativo da premere quando fai clic su una pianta nella barra." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ResetBindings)), "Ripristina comandi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetBindings)), "Ripristina le assegnazioni predefinite per la rotazione e l'elenco delle piante." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableDiagnosticLogging)), "Aggiunge messaggi diagnostici al registro di gioco. Disattivata per impostazione predefinita. Avvisi ed errori vengono sempre registrati." },
                ...
                { "AdvancedForestBrush.UI.SpeciesPalette", "Elenco delle piante" },
                { "AdvancedForestBrush.UI.OpenSpeciesPalette", "Usa elenco delle piante" },
