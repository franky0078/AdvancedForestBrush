    ...
    public sealed class LocaleIT : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "AdvancedForestBrush.UI.SquareTooltip", "Pennello quadrato. Tieni premuti Ctrl e il pulsante destro e muovi il mouse orizzontalmente per ruotarlo. Il clic destro cancella la vegetazione." },
                { "AdvancedForestBrush.UI.Rectangle", "Rettangolo" },
                { "AdvancedForestBrush.UI.RectangleTooltip", "Pennello rettangolare con larghezza e lunghezza separate. Tieni premuto Ctrl e trascina con il pulsante destro per ruotarlo." },
                { "AdvancedForestBrush.UI.Polygon", "Poligono multipunto" },
                { "AdvancedForestBrush.UI.PolygonTooltip", "Clic sinistro per impostare i punti; Backspace rimuove l'ultimo. Clicca il primo punto o fai doppio clic per chiudere. Tieni premuto Ctrl e trascina con il pulsante destro per ruotare il poligono chiuso. Il clic destro cancella la vegetazione. Esc lo reimposta." },
