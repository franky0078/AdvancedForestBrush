    ...
    public sealed class LocaleES : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionTabLocaleID(Setting.kControlsSection), "Asignación de teclas" },
                { m_Setting.GetOptionGroupLocaleID(Setting.kControlsGroup), "Asignación de teclas" },
                { m_Setting.GetBindingMapLocaleID(), "Advanced Forest Brush" },
                { m_Setting.GetBindingKeyLocaleID(Setting.kRotateAction), "Girar pincel" },
                { m_Setting.GetBindingKeyHintLocaleID(Setting.kRotateAction), "Girar pincel" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RotateMouse)), "Girar pincel (ratón)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RotateMouse)), "Mantén pulsados los botones asignados y mueve el ratón horizontalmente para girar el cuadrado, el rectángulo o un polígono cerrado." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RotateKeyboard)), "Girar pincel (teclado)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RotateKeyboard)), "Mantén pulsada la tecla asignada y mueve el ratón horizontalmente para girar el cuadrado, el rectángulo o un polígono cerrado." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ResetBindings)), "Restablecer controles" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetBindings)), "Restaura las asignaciones predeterminadas para girar." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableDiagnosticLogging)), "Escribe mensajes adicionales sobre la herramienta y los polígonos en el registro del juego. Desactivado por defecto. Las advertencias y los errores siempre se registran." },
                ...
                { "AdvancedForestBrush.UI.SquareTooltip", "Pincel cuadrado. Usa el control de giro configurado en Opciones y mueve el ratón horizontalmente. El control de borrado elimina vegetación." },
                { "AdvancedForestBrush.UI.Rectangle", "Rectángulo" },
                { "AdvancedForestBrush.UI.RectangleTooltip", "Pincel rectangular con anchura y longitud independientes. Gíralo con el control configurado en Opciones." },
                { "AdvancedForestBrush.UI.Polygon", "Polígono multipunto" },
                { "AdvancedForestBrush.UI.PolygonTooltip", "Clic izquierdo para colocar puntos; Retroceso elimina el último. Clic en el primer punto o doble clic para cerrar. Gira el polígono cerrado con el control configurado en Opciones. El control de borrado elimina vegetación. Esc lo restablece." },
