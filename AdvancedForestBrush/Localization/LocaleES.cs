    ...
    public sealed class LocaleES : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetBindingKeyLocaleID(Setting.kAddSpeciesAction), "Añadir planta a la lista" },
                { m_Setting.GetBindingKeyHintLocaleID(Setting.kAddSpeciesAction), "Añadir planta seleccionada a la lista" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesMouse)), "Añadir planta (ratón)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesMouse)), "Haz clic en una planta de la barra mientras mantienes la combinación asignada. Predeterminado: Ctrl + clic izquierdo." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Añadir planta (teclado)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Tecla opcional que se pulsa al hacer clic en una planta de la barra." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ResetBindings)), "Restablecer controles" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetBindings)), "Restaura las asignaciones predeterminadas para girar y añadir plantas." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableDiagnosticLogging)), "Añade mensajes de diagnóstico al registro del juego. Desactivado por defecto. Los avisos y errores se registran siempre." },
                ...
                { "AdvancedForestBrush.UI.SpeciesPalette", "Lista de plantas" },
                { "AdvancedForestBrush.UI.OpenSpeciesPalette", "Usar lista de plantas" },
