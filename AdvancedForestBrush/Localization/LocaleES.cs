    ...
    public sealed class LocaleES : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "AdvancedForestBrush.UI.SquareTooltip", "Pincel cuadrado. Mantén pulsado el botón derecho del ratón y mueve el ratón horizontalmente para girarlo." },
                { "AdvancedForestBrush.UI.Rectangle", "Rectángulo" },
                { "AdvancedForestBrush.UI.RectangleTooltip", "Pincel rectangular con anchura y longitud independientes. Se puede girar." },
                { "AdvancedForestBrush.UI.Polygon", "Polígono multipunto" },
                { "AdvancedForestBrush.UI.PolygonTooltip", "Haz clic con el botón izquierdo para colocar puntos. Cierra el polígono haciendo clic en el primer punto o con un doble clic. Después, mantén pulsado el botón derecho del ratón y muévelo horizontalmente para girar el polígono terminado. Esc lo restablece." },
