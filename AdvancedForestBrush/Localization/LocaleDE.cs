    ...
    public sealed class LocaleDE : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "AdvancedForestBrush.UI.SquareTooltip", "Quadratischer Pinsel. Zum Drehen Strg und die rechte Maustaste halten und die Maus waagerecht bewegen. Rechtsklick löscht Vegetation." },
                { "AdvancedForestBrush.UI.Rectangle", "Rechteck" },
                { "AdvancedForestBrush.UI.RectangleTooltip", "Rechteckiger Pinsel mit getrennter Breite und Länge. Mit Strg und gedrückter rechter Maustaste drehbar." },
                { "AdvancedForestBrush.UI.Polygon", "Multipoint-Polygon" },
                { "AdvancedForestBrush.UI.PolygonTooltip", "Linksklick setzt Punkte; Rücktaste entfernt den letzten Punkt. Klick auf den ersten Punkt oder Doppelklick schließt das Polygon. Strg und rechte Maustaste gedrückt halten und die Maus horizontal bewegen, um das fertige Polygon zu drehen. Rechtsklick löscht Vegetation. Esc setzt es zurück." },
