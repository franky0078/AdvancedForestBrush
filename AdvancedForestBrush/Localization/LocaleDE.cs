    ...
    public sealed class LocaleDE : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "AdvancedForestBrush.UI.PolygonTooltip", "Linksklick setzt Punkte. Klick auf den ersten Punkt oder Doppelklick schließt das Polygon. Danach rechte Maustaste gedrückt halten und die Maus horizontal bewegen, um das fertige Polygon zu drehen. Esc setzt es zurück." },
