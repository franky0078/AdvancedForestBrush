    ...
    public sealed class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "AdvancedForestBrush.UI.PolygonTooltip", "Left-click to set points. Close the polygon by clicking the first point or double-clicking. Then hold the right mouse button and move horizontally to rotate the finished polygon. Esc resets it." },
