    ...
    public sealed class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetBindingKeyLocaleID(Setting.kAddSpeciesAction), "Add plant to species list" },
                { m_Setting.GetBindingKeyHintLocaleID(Setting.kAddSpeciesAction), "Add clicked plant to species list" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesMouse)), "Add plant to list (mouse)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesMouse)), "Click a plant in the vegetation bar while holding the assigned modifier. Default: Ctrl + left-click." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Add plant to list (keyboard)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Optional keyboard shortcut to use while clicking a plant in the vegetation bar." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ResetBindings)), "Reset bindings" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetBindings)), "Restores the default rotation and add-to-list bindings." },
                ...
                { "AdvancedForestBrush.UI.SpeciesPalette", "Species list" },
                { "AdvancedForestBrush.UI.OpenSpeciesPalette", "Use species list" },
