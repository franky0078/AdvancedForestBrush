    ...
    public sealed class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "AdvancedForestBrush.UI.SquareTooltip", "Square brush. Hold Ctrl and the right mouse button, then move horizontally to rotate. Right-click erases vegetation." },
                { "AdvancedForestBrush.UI.Rectangle", "Rectangle" },
                { "AdvancedForestBrush.UI.RectangleTooltip", "Rectangular brush with separate width and length. Hold Ctrl and right-drag to rotate." },
                { "AdvancedForestBrush.UI.Polygon", "Multipoint polygon" },
                { "AdvancedForestBrush.UI.PolygonTooltip", "Left-click to set points; Backspace removes the last point. Click the first point or double-click to close. Hold Ctrl and right-drag to rotate the closed polygon. Right-click erases vegetation. Esc resets it." },
