    ...
    public sealed class LocaleFR : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetBindingKeyLocaleID(Setting.kAddSpeciesAction), "Ajouter un végétal à la liste" },
                { m_Setting.GetBindingKeyHintLocaleID(Setting.kAddSpeciesAction), "Ajouter le végétal sélectionné à la liste" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesMouse)), "Ajouter un végétal (souris)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesMouse)), "Cliquez sur un végétal dans la barre en maintenant la touche attribuée. Par défaut : Ctrl + clic gauche." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Ajouter un végétal (clavier)" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.AddSpeciesKeyboard)), "Touche facultative à maintenir lorsque vous cliquez sur un végétal dans la barre." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ResetBindings)), "Réinitialiser les raccourcis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ResetBindings)), "Restaure les commandes par défaut pour la rotation et la liste des végétaux." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EnableDiagnosticLogging)), "Activer les journaux de diagnostic" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableDiagnosticLogging)), "Ajoute des messages de diagnostic dans le journal du jeu. Désactivé par défaut. Les avertissements et erreurs restent toujours enregistrés." },
                ...
                { "AdvancedForestBrush.UI.SpeciesPalette", "Liste des végétaux" },
                { "AdvancedForestBrush.UI.OpenSpeciesPalette", "Utiliser la liste des végétaux" },
